                ...
                <div className="container grid grid-cols-12 px-8  mx-auto">
                    ...
                    >
                        ...
                        <div className="card-body space-y-3">
                            <div>
                                <button className="btn btn-primary bg-[#82CB15] btn-xs text-white font-bold lowercase">
                                restaurants
                                </button>
                                <button className="btn btn-primary bg-[#82CB15] btn-xs text-white font-bold lowercase ml-2">
                                cooking
                                </button>
                            </div>
